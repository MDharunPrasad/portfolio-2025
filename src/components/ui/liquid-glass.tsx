...
const GlassSkillCard: React.FC<{ children: React.ReactNode }> = ({
  children,
}) => (
  <GlassEffect className="rounded-2xl px-6 py-4 hover:px-7 hover:py-5 hover:rounded-3xl overflow-hidden">
    <div
      className="transition-all duration-700 hover:scale-105 text-center"
      style={{
        transitionTimingFunction: "cubic-bezier(0.175, 0.885, 0.32, 2.2)",
      }}
    >
...
export { GlassEffect, GlassDock, GlassButton, GlassSkillCard, GlassFilter };